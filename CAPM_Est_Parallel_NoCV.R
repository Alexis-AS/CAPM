...
#archivo_salida <- paste0("C:/Users/alexi/OneDrive - Universidad Técnica Federico Santa María/2024-2/Paper CAPM/CAPM Oct/results_est_cv_", start_year, "_to_", end_year, ".xlsx")
