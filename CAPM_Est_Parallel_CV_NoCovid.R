  ...
  for (empresa in colnames(final_df_filtrado)) {
    if (grepl("_Return$", empresa)) {
      ...
      tryCatch({
        ...
        variables_adicionales <- final_df_filtrado[, c("Date", "Rm_Rf", "Rm_Rf2", "Rm_Rf3")]
        ...
        fit_result <- stable_lm_custom(
          formula = Retorno ~ Rm_Rf + Rm_Rf2 + Rm_Rf3,
          data = emp_df,
          bounds = bounds
        )
...
procesar_empresa <- function(empresa) {
  tryCatch({
    ...
    market_returns <- final_df_filtrado[, c("Date", "Rm_Rf", "Rm_Rf2", "Rm_Rf3")]
...
archivo_salida <- paste0("C:/Users/alexi/OneDrive - Universidad Técnica Federico Santa María/2025/Paper CAPM/Análisis/Salidas_Estable/results_est_23_", start_year, "_to_", end_year, ".xlsx")
#archivo_salida <- paste0("C:/Users/usuario/OneDrive - Universidad Técnica Federico Santa María/2025/Paper CAPM/Análisis/Salidas_Estable/results_est_23_", start_year, "_to_", end_year, ".xlsx")
